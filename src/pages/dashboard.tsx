...
import { useOrderProductCount, useProductCount, useOrderCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const orderProductStat = useOrderProductCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: orderProductStat?.data,
      isLoading: orderProductStat.isLoading,

...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Cosmetic Products Online`}</title>

        <meta
          name="description"
          content="Welcome to Cosmetic Products Online - Your one-stop destination for purchasing a wide range of cosmetics and beauty products online from ABC, revolutionizing the way you shop for beauty."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1643185539104-3622eb1f0ff6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb3NtZXRpY3N8ZW58MHx8fHwxNjk3NjE5NDE2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@peter_kp007?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Peter Kalonji`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Cosmetic Products Online - Your one-stop destination for purchasing a wide range of cosmetics and beauty products online from ABC, revolutionizing the way you shop for beauty.`}
            </Text>
            <Box

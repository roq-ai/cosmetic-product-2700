...
import { useOrderProductFindFirst, useRoqClient } from 'lib/roq';

import { OrderProductInterface } from 'interfaces/order-product';

function OrderProductViewPage() {
  ...
  const { data, error, isLoading } = useOrderProductFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('order_product', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/order-products/edit/${id}`} passHref legacyBehavior>
                    <Button

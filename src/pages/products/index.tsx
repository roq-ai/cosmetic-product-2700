...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['vendor', 'inventory.count', 'order_product.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('inventory', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('order_product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'order_product',
          header: 'Order Product',
          accessorKey: 'order_product',
          cell: ({ row: { original: record } }: any) => record?._count?.order_product,
        }
      : null,
